# 一录清个人版下载 / ELogSync Personal downloads

## English

ELogSync Personal is the local desktop edition for one user's business memory and follow-up work.
...
一录清个人版适用于单个用户在本机保存业务信息、跟进事项和相关资料。
